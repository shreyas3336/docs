...
3.  **Immutable Token Contract Generation:** The Token Factory executes the `createAgentToken` function (or a similar internal method). This function deploys a new, distinct ERC-20 compliant smart contract for the agent.
