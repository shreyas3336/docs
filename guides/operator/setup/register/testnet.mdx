---
title: 'Testnet Registration Guide'
icon: 'vial'
description: ""
...
<Tabs>
    <Tab title="Private Key Wallets">
        ...
        - [Open “Read Contract” tab in OperatorNetworkOptInService contract](https://holesky.etherscan.io/address/0x58973d16FFA900D11fC22e5e2B6840d9f7e13401#readContract)
    ...
    <Tab title="Multi-Sig (EIP-1271) Wallets">
        ...
        - Put `0x58973d16FFA900D11fC22e5e2B6840d9f7e13401` as contract address
        - Choose `optIn` method
        ...
        4. **Register as an Operator :**
            ...
            **3. Input Contract Details**
            ...
            - **Contract Address:** Enter the address (`0x476Ceb36F6f250297Bb59d45f00bdB053445E9CB`) of the contract containing the `registerAsOperator` function.
