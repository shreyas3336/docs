...
When you use this plugin, Capx ADK generates:
...
npx capx-adk@latest my-ai-app --plugins=vercel-ai
...
npx capx-adk@latest my-app --plugins=vercel-ai,supabase

# AI chat with caching
npx capx-adk@latest my-app --plugins=vercel-ai,vercel-kv

# Full stack AI platform
npx capx-adk@latest my-app --plugins=vercel-ai,firebase,vercel-kv
```
