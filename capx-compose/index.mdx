...
title: 'Overview'
icon: 'book'
description: 'Capx Compose is a powerful CLI scaffolding tool that generates production-ready Next.js applications with pre-configured AI and blockchain integrations. Build once, deploy everywhere with enterprise-grade templates.'
---
