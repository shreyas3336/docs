...
3. **Enter Capx Chain Details:** You will need to provide the following information (exact values for Testnet and Mainnet will be provided here):
   ...
   <Tabs>
     <Tab title="Capx Mainnet">
       | Setting                | Value                                  |
       | ---------------------- | -------------------------------------- |
       | **Network Name**       | `Capx Mainnet`                         |
       | **RPC URL**            | `https://rpc.capx.ai`  |
       | **WSS URL**            | `wss://rpc.capx.ai` |
       | **Chain ID**           | `757`                                |
       | **Currency Symbol**    | `CAPX`                                  |
...
- **Testnet:**
  ...
  - **Faucet URL:** `https://faucet.testnet.capx.ai/`  [➹](https://faucet.testnet.capx.ai/)
- **Mainnet:**
